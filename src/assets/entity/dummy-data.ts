...
export const dummyCategories: Category[] = [
  ...
  },
  {
    category_id: 'trc-003',
    name: 'Hiburan',
    description: 'Pengeluaran untuk hiburan seperti bioskop, konser, dan lainnya',
    color: '#5733FF',
  ...
  },
  {
    category_id: 'trc-004',
    name: 'Kesehatan',
    description: 'Biaya pengeluaran untuk kesehatan seperti obat-obatan atau rumah sakit',
    color: '#33AFFF',
  ...
  },
  {
    category_id: 'trc-005',
    name: 'Pendidikan',
    description: 'Pengeluaran untuk kebutuhan pendidikan seperti buku atau kursus',
    color: '#FF33A1',
